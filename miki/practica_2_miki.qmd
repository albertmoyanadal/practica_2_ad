...
```{r}
data<-data %>% mutate(col24=case_when(
  col24=="No, mai he fet cap formació"~"Mai",
  col24=="Si, vaig fer un curs fa temps"~"Fa temps",
  col24=="He hagut de fer sessions de rehabilitació vocal (logopèdia)"~"Logopeda",
  col24=="He fet la formació Com puc cuidar la meva veu impartida pel Servei de Prevenció"~"Formació",
  col24=="He fet formació vocal pel meu compte"~"Pel seu Compte",
  TRUE~"Altres"
))
```

```{r}
dat_Log <- data %>% filter(col24 == 'Logopeda')
```
